...
std::optional[metadata::FileMetadata](metadata::FileMetadata)
Master::GetFile(
const std::string& path) const {
...
std::optional[metadata::ChunkMetadata](metadata::ChunkMetadata)
Master::GetChunkInfo(
...
std::optional[std::size_t](std::size_t)
...
ChunkHandle handle,
const std::vector[replication::PlacementCandidate](replication::PlacementCandidate)&
candidates) const {
...
std::optional[lease::Lease](lease::Lease)
Master::AcquireLease(
ChunkHandle handle,
...
const std::vector[heartbeat::ReportedChunk](heartbeat::ReportedChunk)&
chunks) {
